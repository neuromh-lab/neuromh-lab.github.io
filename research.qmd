...
## Mechanistic Modeling {#modelling}
...
Our research is anchored in scalp-recorded **Electroencephalography (EEG)**, chosen for its millisecond-level temporal resolution. This lets us track how the brain registers, filters, and evaluates information in real time. Each analytic approach in our work answers a different question.

**Event-Related Potentials (ERPs)** decompose the processing of a stimulus into discrete stages, such as P1/N1, MMN, and N2/P3, and let us ask when in the processing stream group differences emerge. **Time-frequency decomposition** captures oscillatory dynamics such as theta synchrony and alpha power, indexing attention and network rhythms. **Functional connectivity** measures how distributed regions communicate, addressing how networks reorganize across development and across diagnoses. **Computational modeling**, drawing on predictive-coding and related frameworks, quantifies latent cognitive processes that ERPs alone cannot reveal, such as precision-weighting of sensory evidence.

Alongside neural measures, we use behavioral paradigms, clinical assessments, and self-report measures to tie brain signals to lived experience. Together, these tools give us the temporal precision and analytic flexibility to link neural dynamics to mental health across the lifespan.
